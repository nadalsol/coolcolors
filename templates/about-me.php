    ...
    <div class="small-12 medium-10 medium-centered columns">
      <div class="row">
        <div class="small-12 medium-3 columns">
          <h2 class="about-me__title text-uppercase">Miriam Soto</h2>
          <h3 class="about-me__subtitle text-uppercase">Information Architect, <abbr title="User Experience">UX</abbr> &amp; Visual Designer.</h3>
        </div>
        <div class="small-12 medium-8 medium-offset-1 columns" lang="es-ES">
          <h4 class="about-me__lead text-uppercase">Claro. Sencillo. Atractivo.</h4>

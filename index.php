    ...
    <div class="about-me">
      <div class="row">
        <div class="small-12 medium-8 medium-centered large-6 columns">
          <h2 class="about-me__title text-uppercase">¡Hola!</h2>
          <h3 class="about-me__subtitle">Me llamo Miriam, soy diseñadora visual, de experiencia de usuario y arquitecta de la información.</h3>
